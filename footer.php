...
<div class="container">
	...
	©  Emlog大前端 theme By <span id="copyright"><a href="http://blog.yesfree.pw/" title="草窝Blog">草窝</a></span><?php if(!empty($icp)):?><a href="http://www.miibeian.gov.cn" target="_blank"><?php echo $icp; ?></a><?php endif;?><?php echo $footer_info; ?>
	</p>
	<?php 
